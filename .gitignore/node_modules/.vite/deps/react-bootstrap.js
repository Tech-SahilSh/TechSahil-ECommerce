...
var AccordionHeader = /*#__PURE__*/ import_react.forwardRef(({ as: Component = "h2", bsPrefix, className, children, onClick, ...props }, ref) => {
...
var Dropdown = /*#__PURE__*/ import_react.forwardRef((pProps, ref) => {
	...
	const handleToggle = useEventCallback((nextShow, meta) => {
		...
		if (((_meta$originalEvent = meta.originalEvent) == null ? void 0 : (_meta$originalEvent$t = _meta$originalEvent.target) == null ? void 0 : _meta$originalEvent$t.classList.contains("dropdown-toggle")) && meta.source === "mousedown") return;
...
function NoopTransition({ children, in: inProp, onExited, mountOnEnter, unmountOnExit }) {
	...
	const child = /*#__PURE__*/ (0, import_react.cloneElement)(children, { ref: useMergedRefs(ref, children.ref) });
...
//#endregion
//#region node_modules/prop-types-extra/lib/utils/createChainableTypeChecker.js
var require_createChainableTypeChecker = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	function createChainableTypeChecker(validate) {
		function checkType(isRequired, props, propName, componentName, location, propFullName) {
			...
			if (props[propName] == null) {
				if (isRequired) return /* @__PURE__ */ new Error("Required " + location + " `" + propFullNameSafe + "` was not specified " + ("in `" + componentNameSafe + "`."));
				return null;
			}
...
(/* @__PURE__ */ __commonJSMin(((exports, module) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = all;
	var _createChainableTypeChecker2 = _interopRequireDefault(require_createChainableTypeChecker());
...
var Offcanvas = /*#__PURE__*/ import_react.forwardRef(({ bsPrefix, className, children, "aria-labelledby": ariaLabelledby, placement = "start", responsive, show = false, backdrop = true, keyboard = true, scroll = false, onEscapeKeyDown, onShow, onHide, container, autoFocus = true, enforceFocus = true, restoreFocus = true, restoreFocusOptions, onEntered, onExit, onExiting, onEnter, onEntering, onExited, backdropClassName, manager: propsManager, renderStaticNode = false, ...props }, ref) => {
	...
	bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
	const { onToggle } = (0, import_react.useContext)(context$1) || {};
...
var NavbarOffcanvas = /*#__PURE__*/ import_react.forwardRef((props, ref) => {
	const context = (0, import_react.useContext)(context$1);
